...
- Your Formbricks **Workspace ID** (Settings > Connect Your App)
...
<Note>
  User identification is available in this AGPL fork without a license key (upstream: [Enterprise Edition](/self-hosting/advanced/license)).
</Note>
