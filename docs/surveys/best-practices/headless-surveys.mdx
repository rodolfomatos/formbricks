...
For inspiration, you can start looking [here](https://github.com/formbricks/formbricks/tree/main/packages/surveys). As this is an AGPL fork, any modifications you make to the surveys package are covered by the AGPLv3 license of the repository.
