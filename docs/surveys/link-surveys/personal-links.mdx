...
<Note>
  Personal Links are available in this AGPL fork without a license key (upstream: [Enterprise Edition](/self-hosting/advanced/license)).
</Note>
...
- **Enterprise feature**: Available in this AGPL fork without a license (upstream: EE license with Contact Management enabled)
