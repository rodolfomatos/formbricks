...
<Note>
  AI translation is available in this AGPL fork without a license key (upstream: [Enterprise feature](/self-hosting/advanced/license)) and requires **Smart functionality (AI)** to be enabled at the organization level. See [AI Features](/platform/features/ai-features).
</Note>
