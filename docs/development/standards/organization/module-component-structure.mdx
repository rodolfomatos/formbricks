...
### EE Modules (rewritten under AGPL in this fork)

In this fork, the EE module directory (`apps/web/modules/ee`) contains original AGPLv3 rewrites — there is no separate Enterprise license:
