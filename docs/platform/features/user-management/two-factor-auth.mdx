...
<Note>
  Two-factor authentication is available in this AGPL fork without a license key — it is part of the open source [License](/self-hosting/advanced/license).
</Note>
...
3. Follow the setup wizard:
   ...
   **Step 3: Save Backup Codes**
   - **Important**: Save the 8 backup codes in a secure location
...
2. When prompted, enter either:
   ...
   - One of your backup codes (a 10-character lowercase code)
