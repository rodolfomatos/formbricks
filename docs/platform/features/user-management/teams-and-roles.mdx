...
<Note>
  Team-level roles are available in this AGPL fork without a license key. In upstream Formbricks they are part of the [Enterprise Edition](/self-hosting/advanced/license), but in this fork all members can use them.
</Note>
