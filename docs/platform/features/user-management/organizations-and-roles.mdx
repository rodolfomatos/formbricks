...
description: "Understand organization-level roles and how they control access to teams, Workspaces, and data across your Formbricks organization."
icon: "building"
---

Organization-level roles apply to all teams and Workspaces within your Formbricks organization. These roles provide broad permissions that determine what users can do across the entire organization.

<Note>
  Access Roles is available in this AGPL fork without a license key. In upstream Formbricks it is part of the [Enterprise Edition](/self-hosting/advanced/license); in this fork you can invite unlimited members with any role.
</Note>
