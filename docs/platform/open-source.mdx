...
This fork ships all features under the AGPLv3 license — every feature that upstream gates behind its paid Enterprise Edition has been rewritten from scratch and is available here without a license key. See the root `LICENSE` file and [Licensing](/self-hosting/advanced/license).
