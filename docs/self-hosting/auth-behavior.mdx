...
<Note>
  In this AGPL fork, advanced role management features and environment-based SSO behavior are included
  without any license key. Upstream Formbricks requires an [Enterprise license](/self-hosting/advanced/license) for these controls.
</Note>
