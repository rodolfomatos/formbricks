...
add_redis_service() {
  ...
  redis:
    ...
    command: valkey-server --appendonly yes --appendfsync everysec --auto-aof-rewrite-percentage 100 --auto-aof-rewrite-min-size 64mb --maxmemory 512mb --maxmemory-policy volatile-lru
    volumes:
      - redis:/data
"
