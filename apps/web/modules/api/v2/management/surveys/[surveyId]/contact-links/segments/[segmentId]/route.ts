...
/**
 * Handles GET requests for `/api/v2/management/surveys/[surveyId]/contact-links/segments/[segmentId]`. Requires API key authentication. Returns the requested resource(s).
 *
